...
export const BUILTIN_WORKFLOWS = [
  ...
  { id: MUSIC_VIDEO_SHOT_WORKFLOW_ID, label: 'LTX 2.3 Music Video (Dual Input + Audio)', category: 'video', needsImage: true, description: 'Per-shot LTX 2.3 music-video workflow with keyframe/ingredients inputs, audio conditioning, and lip-sync for Director Mode music videos', file: 'music_video_shot_ltx2_3_dual_input.json' },
...
export const BUILTIN_WORKFLOW_PATHS = {
  ...
  [MUSIC_VIDEO_SHOT_WORKFLOW_ID]: getBundledWorkflowPath('music_video_shot_ltx2_3_dual_input.json'),
